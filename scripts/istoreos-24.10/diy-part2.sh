...
#加入OpenClash核心
chmod -R a+x $GITHUB_WORKSPACE/scripts/istoreos-24.10/preset-clash-core.sh
if [ "$1" = "rk33xx" ]; then
    $GITHUB_WORKSPACE/scripts/istoreos-24.10/preset-clash-core.sh arm64
elif [ "$1" = "rk35xx" ]; then
    $GITHUB_WORKSPACE/scripts/istoreos-24.10/preset-clash-core.sh arm64
elif [ "$1" = "phicomm-n1" ]; then
    $GITHUB_WORKSPACE/scripts/istoreos-24.10/preset-clash-core.sh arm64
elif [ "$1" = "x86" ]; then
    $GITHUB_WORKSPACE/scripts/istoreos-24.10/preset-clash-core.sh amd64
fi
